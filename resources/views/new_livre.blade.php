...
<div class="container pt-5 mt-5">
   <form method="{{Route('livre.store')}}" action="POST"  id="monformulaire">
   @csrf
      <div class="row">
         <div class="col-md-4">
      ...
      <div class="row">
         ...
         <div class="col-md-4">  
              <input type="text" class="form-control" name="editeur" placeholder="entre l'editeur" id="editeur"> <br>  <br> 
         </div>
         <div class="col-md-4">    
            <input type="text" class="form-control" name="resume" placeholder="entre un resume" id="resume"> <br>  <br> 
         </div>
      </div>
